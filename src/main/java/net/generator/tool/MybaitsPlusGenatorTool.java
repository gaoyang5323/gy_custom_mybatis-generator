...
public class MybaitsPlusGenatorTool {

    private static String MAPPER_AND_XML_PATH = "/dao/";
    private static String ENTITY_PATH = "/entity/";
    private static String XML_PATH = MAPPER_AND_XML_PATH;
    private static String MAPPER_PATH = MAPPER_AND_XML_PATH;

    /**
     * 作者
     */
    private static String AUTHOR = "gaoyang";
    /**
     * 生成的实体类忽略表前缀: 不需要则置空
     */
     ...
     * entityVO输出模板
     */
    private static String ENTITY_TEMPLATEVO = "templates/entityVO.java.ftl";
    private static String ENTITY_OUTPUT_PATHVO = DAO_OUTPUT_MODULE + "/src/main/java" + PARENT_PACKAGE_PATH + DAO_OUTPUT_MODULE + ENTITY_PATHVO;
    /**
     * mapper.xml输出模板
     */
    ...
    public static void generator(String url, String username, String password, String packagePath, String[] tables) {
        ...
        new AutoGenerator()
                ...
                // 模板配置.因为使用了自定义模板,所以需要把各项置空否则会多生成一次
...
//                .setEntityBuilderModel(true)
    ...
    private static PackageConfig packageConfig() {
        ...
        String Parent = PARENT_PACKAGE_PATH;
    ...
    private static List<FileOutConfig> fileOutConfigList() {
        ...
        String projectPath = "C:\\wf\\mybatis-generator";
        //单体项目不需要拼接model工程名称
//        projectPath = projectPath+"\\xyy-me-channel-core-ms";
        ...
        // list.add(new FileOutConfig(ENTITY_TEMPLATEVO) {
        //     @Override
        //     public String outputFile(TableInfo tableInfo) {
        //         return finalProjectPath + ENTITY_OUTPUT_PATHVO + tableInfo.getEntityName() + "VO" + StringPool.DOT_JAVA;
        //     }
        // });
        // mapper xml文件输出
